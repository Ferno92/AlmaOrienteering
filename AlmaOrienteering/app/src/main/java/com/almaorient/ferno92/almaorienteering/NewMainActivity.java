...
//        vpPager.setAdapter(adapterViewPager);
        ...
        elencoscuoleButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewMainActivity.this, ElencoScuoleActivity.class);
                startActivity(i);
            }
        });
        ...
        modusButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewMainActivity.this, ModusActivity.class);
                startActivity(i);
            }
        });
        ...
        guidaButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewMainActivity.this, InfoAppActivity.class);
                startActivity(i);
            }
        });
        ...
        infoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewMainActivity.this, InfoGeneraliActivity.class);
                startActivity(i);
            }
        });
        ...
        calendarButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewMainActivity.this, CalendarActivity.class);
                startActivity(i);
            }
        });
        ...
        statButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewMainActivity.this, VersusSelectorActivity.class);
                startActivity(i);
            }
        });
        ...
        recensioniButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewMainActivity.this, RecensioniActivity.class);
                startActivity(i);
            }
        });
